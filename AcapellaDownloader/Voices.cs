       ...
       static Voices()
        {
	        VoiceList = new List<Voice>
	        {
		        ...
		        new Voice("Rikke", Gender.Male, "da_dk", "dad_rikke_22k_ns.bvcu"),
		        ...
		        new Voice("Melany", Gender.Female, "en_ca", "en_ca_melany_22k_ns.bvcu"),
		        new Voice("Victoria", Gender.Female, "en_ca", "en_ca_victoria_22k_ns.bvcu"),
		        new Voice("Julian", Gender.Male, "en_ca", "en_ca_julian_22k_ns.bvcu"),
		        ...
		        new Voice("VidhiEnglish", Gender.Female, "en_in", "en_in_vidhienglish_22k_ns.bvcu"),
		        new Voice("Amy", Gender.Female, "en_gb", "en_nen_amy_22k_ns.bvcu"),
		        new Voice("Alfie", Gender.Male, "en_gb", "en_nen_alfie_22k_ns.bvcu"),
			new Voice("Archie", Gender.Male, "gd_GB", "en_sct_archie_22k_ns.bvcu"),
			new Voice("Eilidh", Gender.Female, "gd_GB", "en_sct_eilidh_22k_ns.bvcu"),
			new Voice("Rhona", Gender.Female, "gd_GB", "en_sct_rhona_22k_ns.bvcu"),
		        new Voice("Darius", Gender.Male, "en_us", "enu_darius_22k_ns.bvcu"),
		        new Voice("Rod", Gender.Male, "en_us", "enu_rod_22k_ns.bvcu"),
		        new Voice("Malik", Gender.Male, "en_us", "enu_malik_22k_ns.bvcu"),
		        ...
		        new Voice("Jorvik", Gender.Male, "en_us", "enu_jorvik_22k_ns.bvcu"),
		        new Voice("Camryn", Gender.Female, "en_us", "enu_camryn_22k_ns.bvcu"),
		        new Voice("Baelara", Gender.Female, "en_us", "enu_baelara_22k_ns.bvcu"),
		        new Voice("Faelena", Gender.Female, "en_us", "enu_faelena_22k_ns.bvcu"),
		        new Voice("Ilion", Gender.Male, "en_us", "enu_ilion_22k_ns.bvcu"),
			new Voice("Kenny", Gender.Male, "en_us", "enu_kenny_22k_ns.bvcu"),
		        new Voice("Gilthor", Gender.Male, "en_us", "enu_gilthor_22k_ns.bvcu"),
		        new Voice("Tiana", Gender.Female, "en_us", "enu_tiana_22k_ns.bvcu"),
			new Voice("WillBadGuy", Gender.Male, "en_us", "enu_willbadguy_22k_ns.bvcu"),
		        ...
		        new Voice("ValeriaEnglish", Gender.Female, "en_us", "enu_valeriaenglish_22k_ns.bvcu"),
		        new Voice("Owen", Gender.Male, "en_us", "enu_owen_22k_ns.bvcu"),
		        new Voice("Eldowen", Gender.Male, "en_us", "enu_eldowen_22k_ns.bvcu"),
		        new Voice("Lizzie", Gender.Female, "en_us", "enu_lizzie_22k_ns.bvcu"),
			new Voice("Laura", Gender.Female, "en_us", "enu_laura_22k_ns.bvcu"),
		        ...
		        new Voice("EmilioEnglish", Gender.Male, "en_us", "enu_emilioenglish_22k_ns.bvcu"),
		        ...
		        new Voice("Tamira", Gender.Female, "en_us", "enu_tamira_22k_ns.bvcu"),
		        new Voice("Alinora", Gender.Female, "en_us", "enu_alinora_22k_ns.bvcu"),
		        new Voice("Haldria", Gender.Female, "en_us", "enu_haldria_22k_ns.bvcu"),
			new Voice("Karen", Gender.Female, "en_us", "enu_karen_22k_ns.bvcu"),
		        ...
		        new Voice("Valeria", Gender.Female, "es_us", "spu_valeria_22k_ns.bvcu"),
		        new Voice("Emilio", Gender.Male, "es_us", "spu_emilio_22k_ns.bvcu"),
		        ...
		        new Voice("Anthony", Gender.Male, "fr_ca", "frc_anthony_22k_ns.bvcu"),
		        new Voice("Victoire", Gender.Female, "fr_ca", "frc_victoire_22k_ns.bvcu"),
		        new Voice("Julien", Gender.Male, "fr_ca", "frc_julien_22k_ns.bvcu"),
		        new Voice("Melanie", Gender.Male, "fr_ca", "frc_melanie_22k_ns.bvcu"),
			new Voice("Manon", Gender.Female, "fr_fr", "frf_manon_22k_ns.bvcu"),
		        new Voice("Alice", Gender.Female, "fr_fr", "fr_be_alice_22k_ns.bvcu"),
		        ...
		        new Voice("Julie", Gender.Female, "fr_fr", "fr_be_julie_22k_ns.bvcu"),
		        ...
		        new Voice("Antoine", Gender.Male, "fr_fr", "fr_be_antoine_22k_ns.bvcu"),
		        ...
		        new Voice("Vidhi", Gender.Female, "hi_in", "hi_in_vidhi_22k_ns.bvcu"),
			new Voice("Aurora", Gender.Female, "it_it", "iti_aurora_22k_ns.bvcu"),
		        ...
		        new Voice("Jasmijn", Gender.Female, "nl_nl", "dun_jasmijn_22k_ns.bvcu"),
		        new Voice("Thijs", Gender.Female, "nl_nl", "dun_thijs_22k_ns.bvcu"),
		        new Voice("Merel", Gender.Male, "nl_nl", "dun_merel_22k_ns.bvcu"),
			new Voice("Max", Gender.Male, "nl_nl", "dun_max_22k_ns.bvcu"),
		        ...
		        new Voice("Piotr", Gender.Male, "pl_pl", "pop_piotr_22k_ns.bvcu"),
			new Voice("Marcia", Gender.Female, "pt_br", "pob_marcia_22k_ns.bvcu"),
		        new Voice("Sergio", Gender.Male, "pt_br", "pob_sergio_22k_ns.bvcu"),
			new Voice("Celia", Gender.Female, "pt_pt", "poe_celia_22k_ns.bvcu"),
		        new Voice("Isabel", Gender.Female, "pt_pt", "poe_isabel_22k_ns.bvcu"),
